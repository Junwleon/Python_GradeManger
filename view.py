...
class InputFrame(Frame): # 继承Frame类  
    def __init__(self, master=None):  
        ...
        self.E1 = Entry(self ,bg='#AFEEEE')
        self.E2 = Entry(self,bg='#AFEEEE')
        self.E3 = Entry(self,bg='#AFEEEE')
        self.E4 = Entry(self,bg='#AFEEEE')
        self.E5 = Entry(self,bg='#AFEEEE')
        self.E6 = Entry(self,bg='#AFEEEE')
        self.createPage()  
    ...
    def createPage(self):  
        ...
        Label(self, text = '姓名: ',font=('仿宋',9)).grid(row=1, stick=W, pady=10)
        self.E1.grid(row=1, column=1, stick=E)

        Label(self, text = '学号: ',font=('仿宋',9)).grid(row=2, stick=W, pady=10)
        self.E2.grid(row=2, column=1, stick=E)

        Label(self, text = '科目: ',font=('仿宋',9)).grid(row=3, stick=W, pady=10)
        self.E3.grid(row=3, column=1, stick=E) 

        Label(self, text = '成绩: ',font=('仿宋',9)).grid(row=4, stick=W, pady=10)
        self.E4.grid(row=4, column=1, stick=E)       
        
        Button(self, text='录入',command=self.click,bg='#90EE90',fg='#000000').grid(row=6, column=1, stick=E, pady=10)
...
class DeleteFrame(Frame): # 继承Frame类  
    ...
    def createPage(self):
        ...
        Label(self, text = '学号: ',font=('仿宋',9)).grid(row=1, stick=W, pady=10)
        self.E1.grid(row=1, column=1, stick=E)

        Label(self, text = '科目: ',font=('仿宋',9)).grid(row=2, stick=W, pady=10)
        self.E2.grid(row=2, column=1, stick=E)

        Button(self, text='删除',command=self.click ,bg='#90EE90',fg='#000000').grid(row=6, column=1, stick=E, pady=10)
...
class ModifyFrame(Frame): # 继承Frame类  
    ...
    def createPage(self):  
        ...
        Button(self, text='修改',command=self.click ,bg='#90EE90',fg='#000000').grid(row=6, column=1, stick=E, pady=10)
...
class QueryFrame(Frame): # 继承Frame类  
    ...
    def createPage(self):
        ...
        Button(self, text='查找',command=self.click ,bg='#90EE90',fg='#000000').grid(row=6, column=1, stick=E, pady=10)
